  ...
  return (
    <FormModal title="Add Effect" onClose={closeModal} open={true} maxWidth="sm">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <h3 className="text-base font-semibold text-gray-900 mb-4">Effect Details</h3>

          <div className=" text-xs space-y-4">
            <TextInput
              label="Effect Name"
              name="name"
              placeholder="e.g., Spiral, Fade In, Parallax Scroll"
              required
              value={formData.name}
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="px-6 py-2 text-xs font-medium text-white bg-[#267282] hover:bg-[#267282]/90 
                     rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed
